...
def validate(
    ...
    LA_list.extend([420, 815, 816, 825, 826, 830, 831, 840, 841, 845, 846, 860, 861, 908, 909, 916, 919, 921, 925, 926, 928, 929, 931, 933])
    #That was fun
...
def test_validate():
    ...
    assert result.definition.message == "UPN invalid (characters 2-4 not a recognised LA code)"
