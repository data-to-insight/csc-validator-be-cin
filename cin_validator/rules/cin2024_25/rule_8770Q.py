...
@rule_definition(
    ...
    message="Please check and either amend data or provide a reason: UPN is missing or reason UPN is missing or is UN1 for a child who is of school age.",
...
def validate(
    ...
    # and <PersonBirthDate> (N00066) is greater than or equal to [<ReferenceDate> (N00603) minus 4 years]
...
def test_validate():
    ...
    sample_cid = pd.DataFrame(
        [
            ...
            {
                "LAchildID": "child2",  # 1 Pass - over under school age with UPN
                "PersonBirthDate": "26/05/1990",
                "UPN": "AAA",
                "UPNunknown": pd.NA,
            },
            {
                "LAchildID": "child3",  # 2 Pass - over school age with valid UPNunknown
                "PersonBirthDate": "26/05/1990",
                "UPN": pd.NA,
                "UPNunknown": "UN2",
            },
            {
                "LAchildID": "child4",  # 3 Pass - over school age with valid UPNunknown (lower case)
                "PersonBirthDate": "26/05/1990",
                "UPN": pd.NA,
                "UPNunknown": "un5",
            },
            ...
            {
                "LAchildID": "child7",  # 6 Ignore - over school age and no UPN or valid UPNunknown (UN8 is not valid) so should fail, BUT ReferralNFA doesn't meet requirement
                "PersonBirthDate": "26/05/1990",
                "UPN": pd.NA,
                "UPNunknown": "UN8",
            },
    ...
    assert (
        ...
        == "Please check and either amend data or provide a reason: UPN is missing or reason UPN is missing or is UN1 for a child who is of school age."
    )
