...
ruleset_updates["2022_23"] = {"deleted": [], "ruleset": cin22_23}
ruleset_years.append("2022_23")
registry.reset()
...
ruleset_updates["2023_24"] = {"deleted": [], "ruleset": cin23_24}
ruleset_years.append("2023_24")
registry.reset()
...
def create_registry(ruleset=ruleset_years[-1]):
    """
    :param str ruleset: year whose version of rules should be run. e.g 2022_23. Defaults to latest recorded year.
    """

    chosen_ruleset_ind = ruleset_years.index(ruleset)

    # the 2022_23 ruleset will always be the starting point.
    combined_ruleset = ruleset_updates["2022_23"]["ruleset"]

    # loop starts from position 1 because 2022_23 is in position 0.
